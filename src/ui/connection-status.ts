 ...
 *     player back at SOLO CONTRACT, exactly as the entry screen's offline error does
  ...
  switch (input.state) {
    ...
    case 'closed': {
      ...
      return {
        ...
        detail: ended ? ended.detail : 'Lost the match server. SOLO CONTRACT still works offline.',
        spinner: false,
        grace: null,
        action: 'BACK TO MENU',
      };
