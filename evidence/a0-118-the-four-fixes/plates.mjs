/**
 * evidence/a0-118-the-four-fixes/plates.mjs — compose the manifest's plates.
 ...
 *
 * Inherited from a0-99 (and a0-96 before it) unchanged except for its paths, deliberately: two briefs
 * whose plates are composed by the same script are two briefs whose plates can be
 * compared without asking whether the difference is in the evidence or in the
 * layout.
 *
