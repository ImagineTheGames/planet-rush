# a0-98 — state × viewport × topmost element, the **broken** bundle

Generated, not typed: `node evidence/a0-98-corner-collisions-everywhere-else/table.mjs broken` (add `--full` for every control of every state, including
...
| match-pause-menu | desktop-1280x800 | **SHOWN** x1079–1268 y744–788 | `__cornerStage.elements[7]<nameplates>` *(drawn, not pressable)* @ 473,512 | `CANVAS#app` | clear (readout, not a control) |
...
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[0]<ship-local>` *(drawn, not pressable)* @ 399,192 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[1]<build-button>` @ 92,172 | `CANVAS#app` | clear |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[2]<build-badge>` *(drawn, not pressable)* @ 101,370 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[3]<pause-button>` @ 96,40 | `CANVAS#app` | clear |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[4]<ore-hud>` *(drawn, not pressable)* @ 39,37 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[5]<banked-total>` *(drawn, not pressable)* @ 21,38 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[6]<station-hp>` *(drawn, not pressable)* @ 705,36 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[7]<zoom-control>` @ 750,85 | `CANVAS#app` | clear |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[8]<nameplates>` *(drawn, not pressable)* @ 495,112 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[9]<minimap>` @ 626,332 | `BUTTON#playtest-download-log-button` · 100% under the offer | **COLLISION** |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `dom#pr-link-loss-reconnect` @ 294,238 | `CANVAS#app` | clear |
| online-match-severed | phone-798x384 | **SHOWN** x477–786 y290–372 | `dom#pr-link-loss-abandon` @ 503,238 | `CANVAS#app` | clear |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[0]<ship-local>` *(drawn, not pressable)* @ 399,192 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[1]<build-button>` @ 92,172 | `CANVAS#app` | clear |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[2]<build-badge>` *(drawn, not pressable)* @ 101,370 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[3]<pause-button>` @ 96,40 | `CANVAS#app` | clear |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[4]<ore-hud>` *(drawn, not pressable)* @ 39,37 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[5]<banked-total>` *(drawn, not pressable)* @ 21,38 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[6]<station-hp>` *(drawn, not pressable)* @ 705,36 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[7]<zoom-control>` @ 750,85 | `CANVAS#app` | clear |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[8]<nameplates>` *(drawn, not pressable)* @ 495,112 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `__cornerStage.elements[9]<minimap>` @ 626,332 | `BUTTON#playtest-download-log-button` · 100% under the offer | **COLLISION** |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `dom#pr-link-loss-reconnect` @ 294,238 | `CANVAS#app` | clear |
| online-match-kicked-out | phone-798x384 | **SHOWN** x477–786 y290–372 | `dom#pr-link-loss-abandon` @ 503,238 | `CANVAS#app` | clear |
...
| online-match-guest-healthy | guest-desktop | never mounted | — | — | 9 controls drawn; the offer is not on this screen |
| online-match-live | phone-portrait-390x844 | never mounted | — | — | 10 controls drawn; the offer is not on this screen |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[0]<ship-local>` *(drawn, not pressable)* @ 195,422 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[1]<build-button>` @ 212,92 | `CANVAS#app` | clear |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[2]<build-badge>` *(drawn, not pressable)* @ 15,101 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[3]<pause-button>` @ 350,96 | `CANVAS#app` | clear |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[4]<ore-hud>` *(drawn, not pressable)* @ 354,39 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[5]<banked-total>` *(drawn, not pressable)* @ 353,21 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[6]<station-hp>` *(drawn, not pressable)* @ 355,751 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[7]<zoom-control>` @ 305,796 | `CANVAS#app` | clear |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[8]<nameplates>` *(drawn, not pressable)* @ 275,518 | `CANVAS#app` | clear (readout, not a control) |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[9]<minimap>` @ 52,672 | `BUTTON#playtest-download-log-button` · 99% under the offer | **COLLISION** |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `dom#pr-link-loss-reconnect` @ 195,433 | `CANVAS#app` | clear |
| online-match-severed | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `dom#pr-link-loss-abandon` @ 195,487 | `CANVAS#app` | clear |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[0]<ship-local>` *(drawn, not pressable)* @ 195,422 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[1]<build-button>` @ 212,92 | `CANVAS#app` | clear |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[2]<build-badge>` *(drawn, not pressable)* @ 15,101 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[3]<pause-button>` @ 350,96 | `CANVAS#app` | clear |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[4]<ore-hud>` *(drawn, not pressable)* @ 354,39 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[5]<banked-total>` *(drawn, not pressable)* @ 353,21 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[6]<station-hp>` *(drawn, not pressable)* @ 355,751 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[7]<zoom-control>` @ 305,796 | `CANVAS#app` | clear |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[8]<nameplates>` *(drawn, not pressable)* @ 275,518 | `CANVAS#app` | clear (readout, not a control) |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `__cornerStage.elements[9]<minimap>` @ 52,672 | `BUTTON#playtest-download-log-button` · 99% under the offer | **COLLISION** |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `dom#pr-link-loss-reconnect` @ 195,433 | `CANVAS#app` | clear |
| online-match-kicked-out | phone-portrait-390x844 | **SHOWN** x12–91 y571–832 | `dom#pr-link-loss-abandon` @ 195,487 | `CANVAS#app` | clear |
