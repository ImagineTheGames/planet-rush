/**
 * evidence/a0-110-friend-or-foe-minimap/stack.mjs — read the pair, at a size a
 * human eye can actually judge. OWNER: UI Engineer (a0-110). Analysis tool, not a
 * golden and not a test. Ported unchanged from a0-88's, which was written for the
 * same question on the same surface.
 *
 ...
 *
 * Usage:
 *   node evidence/a0-110-friend-or-foe-minimap/stack.mjs <name> [scale]
 *     e.g. node evidence/a0-110-friend-or-foe-minimap/stack.mjs phone-collapsed 4
