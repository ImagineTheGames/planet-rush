/**
 * evidence/a0-99-wheel-and-hud/plates.mjs — compose the manifest's plates.
 ...
 *
 * Inherited from a0-96 unchanged except for its paths, deliberately: two briefs
 ...
 * layout.
 *
 *   node evidence/a0-99-wheel-and-hud/plates.mjs
 */
