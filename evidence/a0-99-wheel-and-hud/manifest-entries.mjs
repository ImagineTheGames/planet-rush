/**
 * evidence/a0-99-wheel-and-hud/manifest-entries.mjs — append a0-99's entries to
 * evidence/manifest.json. OWNER: QA Manager (a0-99).
 *
 ...
 *
 *   node evidence/a0-99-wheel-and-hud/manifest-entries.mjs
 */
