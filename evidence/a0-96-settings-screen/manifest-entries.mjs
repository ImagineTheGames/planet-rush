/**
 * evidence/a0-96-settings-screen/manifest-entries.mjs — append a0-96's entries to
 * evidence/manifest.json. OWNER: QA Manager (a0-96).
 *
 ...
 *
 *   node evidence/a0-96-settings-screen/manifest-entries.mjs
 */
