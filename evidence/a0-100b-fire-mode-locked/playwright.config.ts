/**
 * evidence/a0-100b-fire-mode-locked/playwright.config.ts — a private capture
 * config. OWNER: UI Engineer (a0-100b).
 *
...
export default defineConfig({
  ...
  webServer: {
    ...
    url: URL,
    reuseExistingServer: Boolean(process.env.A0_100B_REUSE),
    timeout: 900_000,
  },
});
