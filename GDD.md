...
Built at your own station, paid in ore. **Construction takes time** — a turret assembles over ~10 seconds, a shield over ~15 — so defenses are bought before the attack, not during it. Per-station caps (baseline: 4 turrets, 2 shields) are design rules, not renderer limits.
