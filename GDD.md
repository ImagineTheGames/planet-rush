...
### 2.1 Match setup *(amended 2026-07-27 — modes, slot model, variable size, four maps; amended 2026-08-05 — sides read FRIENDLY / ENEMY + letter; **amended 2026-08-07 — an `open` slot is EMPTY: `N` counts humans plus bots, and RUSH! is refused below two participants**; see `docs/design-amendments.md` and `docs/variable-slots-plan.md`)*
