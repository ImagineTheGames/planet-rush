...
### 2.1 Match setup *(amended 2026-07-27 — modes, slot model, variable size, four maps; amended 2026-08-05 — sides read FRIENDLY / ENEMY + letter; **amended 2026-08-07 — the host picks each bot's CHARACTER, and its difficulty is shown**; see `docs/design-amendments.md` and `docs/variable-slots-plan.md`)*
