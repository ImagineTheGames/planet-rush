...
**Status.** `npx tsc --noEmit` clean, `npm test -- --run` green, PR #461 open.
The only thing outstanding is CI: the six Playwright mobile-emulation shards were
still running at last check. No blockers.
