...
| musicBed | done | "none of these sound like a calm music bed" | four CHORDS in A minor, held and low, moving only by very slow vibrato (a filter sweep inside a loop wraps to a wobble, and a wobble is the opposite of calm). Full triad / open fifth / triad with a light / two voices and a sub |
| musicPulse | done | "none of these sound musical" | the pulse is now a BASS NOTE. Round one offered four rhythms and not one carried a nameable pitch — a pulse without a note in it is a metronome. Root-and-fifth, pulse under a held third, a two-note rise, a pedal with an answer |
| musicTheme | done | "these sound like very bad music" | the riff was the problem, and §7.5 was why round one would not touch it. Seven notes over ONE held A means every note lands on the same chord. Four pieces where the harmony moves: four chords / a walking bass / two chords breathing / a pedal and one answer |
| musicDread | done | "none of these sound critical they just sound annoying" | "annoying" is a register (round one's `d` put 20% of its energy above 3 kHz and held it for 5.5 s); "critical" is weight plus something that CHANGES. Nothing above 1 kHz in any layer, and something moves across every lap: a low tritone / a creeping voice / a quickening heartbeat / the room emptying |
